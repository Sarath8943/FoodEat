...
const { createOrder, getAllOrders, getOrderById, getAllRestaurantOrders, updateOrderUser, updateOrderStatus, getMyOrders } = require('../controllers/orderController');
...
router.get('/get-all-order/:userId',roleMiddleware(['user']),getMyOrders);
